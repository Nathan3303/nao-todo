...
| :------- | :------- | :--- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------- | :------------------------- |
| T98      | rd-fe    | 前端 | **DEF-4 micro-task**：`apps/web/src/components/calendar/daily/__tests__/daily-view.test.ts:199` fixture `endAt: '2026-09-22 10:00:00'` → **相对当天**（同目录已用 `const TODAY = dayjs().format('YYYY-MM-DD')` 惯例）+ 补 `import dayjs`；`createdAt`（L200）**不动**（不参与日网格定位）。验收 = 全仓 `vp test` 无 DEF-4 红，且该文件 17 例全绿 | 2026-09-23 | —（非本批 AC，属缺陷清理） |
