<template>
    ...
    >
        ...
        <nue-div align="center" style="padding: 4px 16px" gap="16px" :divider="{}">
            ...
            <nue-text size="12px" color="gray" style="width: 96px">Priority</nue-text>
        ...
        <template v-else>
            ...
            >
                ...
                <todo-priority-info :priority="todo.priority"></todo-priority-info>
                <todo-state-info :state="todo.state"></todo-state-info>
                <nue-icon
                    name="delete"
                    color="#FF5722"
