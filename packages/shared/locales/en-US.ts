...
const enUS: LocaleMessages = {
    ...
    'task.details.export.button': 'Export',
    'task.details.export.title': 'Export Task',
    ...
    'task.details.export.label.startAt': 'Start Time',
    'task.details.export.label.endAt': 'Deadline',
    'task.details.export.label.project': 'Project',
    ...
    'date.dayAfterTomorrow': 'Day after tomorrow {time}',
    'date.thisWeek': '{weekday} {time}',
    'date.lastWeek': 'Last {weekday} {time}',
    'date.nextWeek': 'Next {weekday} {time}',
    'date.thisMonth': 'This month, {day} at {time}',
    'date.lastMonth': 'Last month, {day} at {time}',
    'date.nextMonth': 'Next month, {day} at {time}',
    'date.thisYear': '{month}/{day} {time}',
    'date.lastYear': 'Last year {month}/{day} {time}',
    'date.nextYear': 'Next year {month}/{day} {time}',
    'date.fallbackFormat': 'YYYY-MM-DD HH:mm',
    ...
    'welcome.message':
        'Welcome back to NaoTodo, keep planning and completing your tasks \u{1F3AF}!',

    // Mobile task screens
    'mobile.taskList.empty': 'Nothing here yet. Tap the button below to create a task.',
    'mobile.taskList.loading': 'Loading…',
    'mobile.taskList.createTask': 'New Task',
    'mobile.taskList.menu': 'Menu',
    'mobile.taskCreate.title': 'New Task',
    'mobile.taskCreate.namePlaceholder': 'Task name',
    'mobile.taskCreate.descriptionPlaceholder': 'Description (optional)',
    'mobile.taskCreate.submit': 'Create Task',
    'mobile.taskCreate.state': 'State',
    'mobile.taskCreate.priority': 'Priority',
    'mobile.taskCreate.project': 'Project',
    'mobile.taskCreate.tags': 'Tags',
    'mobile.taskCreate.startAtPlaceholder': 'Start (e.g. 2026-06-01 09:00, empty = today)',
    'mobile.taskCreate.endAtPlaceholder': 'End (e.g. 2026-06-01 18:00, empty = today)',
    'mobile.taskCreate.projectEmpty': 'No projects yet. Create one in the sidebar under Projects.',
    'mobile.taskCreate.tagEmpty': 'No tags yet. Create one in the sidebar under Tags.',
    'mobile.taskDetail.description': 'Description',
    'mobile.taskDetail.checkItems': 'Check Items',
    'mobile.taskDetail.addCheckItem': 'Add Check Item',
    'mobile.taskDetail.checkItemPlaceholder': 'Enter a check item, then tap add',
    'mobile.taskDetail.subTasks': 'Subtasks',
    'mobile.taskDetail.subTaskPlaceholder': 'Enter a subtask name, then tap add',
    'mobile.taskDetail.addSubTask': 'Add Subtask',
    'mobile.taskDetail.subTaskProgress': 'Done {done}/{total}',
    'mobile.taskDetail.subTaskEmpty': 'No subtasks yet. Add one below.',
    'mobile.taskDetail.comments': 'Comments',
    'mobile.taskDetail.addComment': 'Post Comment',
    'mobile.taskDetail.commentPlaceholder': 'Write a comment…',
    'mobile.taskDetail.delete': 'Delete Task',
    'mobile.taskDetail.restore': 'Restore Task',
    'mobile.taskDetail.deletedTip': 'This task is in the trash',
    'mobile.taskDetail.dangerZone': 'Danger Zone',
    'mobile.project.title': 'Projects',
    'mobile.project.create': 'New Project',
    'mobile.project.namePlaceholder': 'Project name',
    'mobile.project.color': 'Color',
    'mobile.project.delete': 'Delete',
    'mobile.project.restore': 'Restore',
    'mobile.project.deletedSection': 'Deleted projects',
    'mobile.tag.title': 'Tags',
    'mobile.tag.create': 'New Tag',
    'mobile.tag.namePlaceholder': 'Tag name',
    'mobile.tag.color': 'Color',
    'mobile.tag.delete': 'Delete',
    'mobile.sidebar.lists': 'Lists',
    'mobile.sidebar.projects': 'Projects',
    'mobile.sidebar.tags': 'Tags',
    'mobile.sidebar.manageProjects': 'Manage Projects',
    'mobile.sidebar.manageTags': 'Manage Tags',
    'mobile.sidebar.profile': 'Profile',
    'mobile.settings.signOut': 'Sign Out',
    'mobile.common.back': 'Back',
    'mobile.common.save': 'Save',
    'mobile.common.cancel': 'Cancel',
    'mobile.common.loadFailed': 'Load failed. Please retry.',

    // Date picker
    'mobile.datePicker.today': 'Today',
    'mobile.datePicker.tomorrow': 'Tomorrow',
    'mobile.datePicker.weekSunday': 'Sunday',
    'mobile.datePicker.weekMonday': 'Monday',
    'mobile.datePicker.clear': 'Clear',
    'mobile.datePicker.cancel': 'Cancel',
    'mobile.datePicker.confirm': 'OK',

    // List toolbar (sort / filter / more)
    'mobile.taskList.sort': 'Sort',
    'mobile.taskList.sortField': 'Sort by',
    'mobile.taskList.sortOrder': 'Order',
    'mobile.taskList.sortAsc': 'Ascending',
    'mobile.taskList.sortDesc': 'Descending',
    'mobile.taskList.filter': 'Filter',
    'mobile.taskList.filterAll': 'All',
    'mobile.taskList.more': 'More',
    'mobile.taskList.refresh': 'Refresh',
    'mobile.taskList.hideCompleted': 'Hide Completed',
    'mobile.taskList.showCompleted': 'Show Completed'
}
