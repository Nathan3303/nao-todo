...
import type { TaskInMemoryRepositoryStates } from '../repositories/task-in-memory'
import { computed, type ComputedRef, reactive } from 'vue'

export interface TaskInMemoryDomain {
    remakeTaskMap(): void
    ...
    list(): ComputedRef<TaskEntity[]>
    setTasks(tasks: TaskEntity[]): void
}

const useTaskInMemoryDomain = () => {
    // @states 任务状态
...
export default useTaskInMemoryDomain
