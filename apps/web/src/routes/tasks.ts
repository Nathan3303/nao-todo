...
const links = [
    ...
    {
        path: 'today',
        meta: { category: 'basic', title: '今日任务', id: 'today' }
    },
    {
        path: 'tomorrow',
        meta: { category: 'basic', title: '明日任务', id: 'tomorrow' }
    },
    { path: 'week', meta: { category: 'basic', title: '最近7天', id: 'week' } },
    {
        path: 'inbox',
        meta: { category: 'basic', title: '收集箱', id: 'inbox' }
    },
    { path: '$p:projectId?', meta: { category: 'project', id: 'project' } },
    { path: '$t:tagId?', meta: { category: 'tag', id: 'tag' } },
    {
        path: 'favorite',
        meta: { category: 'basic', title: '已收藏', id: 'favorite' }
    },
    {
        path: 'recycle',
        meta: { category: 'basic', title: '垃圾桶', id: 'recycle' }
    }
]
