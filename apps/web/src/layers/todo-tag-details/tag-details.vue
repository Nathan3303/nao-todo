...
// import type { Todo, Tag } from '@nao-todo/types'
import type { TodoTagDetailsProps, TodoTagDetailsEmits } from './types'

defineOptions({ name: 'TodoTagDetails' })
defineProps<TodoTagDetailsProps>()
defineEmits<TodoTagDetailsEmits>()
