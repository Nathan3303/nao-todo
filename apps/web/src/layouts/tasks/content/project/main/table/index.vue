        ...
        <nue-main>
            <nue-content fill style="overflow: hidden">
                ...
                <task-table
                    ...
                    @update-columns="viewContext.projectHandlers.updateColumns"
                    @update-sort-options="viewContext.projectHandlers.updateSortOptions"
                    @clear-sort-options="viewContext.projectHandlers.clearSortOptions"
