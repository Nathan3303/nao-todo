        ...
        <nue-main>
            <nue-content fill style="overflow: hidden">
                ...
                <task-table
                    ...
                    @update-columns="viewContext.tagHandlers.updateColumns"
                    @update-sort-options="viewContext.tagHandlers.updateSortOptions"
                    @clear-sort-options="viewContext.tagHandlers.clearSortOptions"
