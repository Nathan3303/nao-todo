...
const { viewContext, tasks, taskLoader, initTable, handleUpdatePage, handleUpdatePerPage } =
    useTable()
        ...
        <nue-main>
            <nue-content fill style="overflow: hidden">
                ...
                <task-table
                    ...
                    @update-sort-options="viewContext.builtInProjectHandlers.updateSortOption"
